...

{
  ...
  for (
    ...
    {name => "IPAMonaPGothic",
     url => q<https://web.archive.org/web/20140724063350/http://www.geocities.jp/ipa_mona/>},
    {name => "Monapo",
     url => q<https://web.archive.org/web/20110616005703/http://www.geocities.jp/ep3797/modified_fonts_01.html>},
    {name => "Mona",
